...
export default function NumberDaysHistoricalJourney({ days }: { days: number }) {
    ...
    return (
        <div className="flex flex-col justify-between p-6 bg-black text-white rounded-lg shadow-lg text-left min-w-50">
            <h1 className="text-md sm:text-lg lg:text-xl font-semibold mb-3 sm:mb-4">Journey Duration</h1>
